...
use App\Http\Controllers\DocumentExtractController;
...
Route::middleware(['auth'])->prefix('app')->group(function () {
    ...
    Route::middleware(['verified'])->group(function () {
        ...
        Route::get('document-extract', [DocumentExtractController::class, 'create'])->name('document-extract.create');
        Route::post('document-extract', [DocumentExtractController::class, 'store'])->name('document-extract.store');
        Route::get('document-extract/preview', [DocumentExtractController::class, 'preview'])->name('document-extract.preview');
        Route::post('document-extract/download', [DocumentExtractController::class, 'download'])->name('document-extract.download');
        Route::post('document-extract/send-to-sheet', [DocumentExtractController::class, 'sendToSheet'])->name('document-extract.send-to-sheet');
